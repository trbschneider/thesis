%!TEX root = ../thesis.tex
\renewcommand{\SF}{{\ensuremath{\mathcal{SF}}}}
\renewcommand{\OI}{{\ensuremath{\mathcal{OI}}}}
\renewcommand{\SD}{{\ensuremath{\mathcal{SF}_{pulses}}}}
\renewcommand{\DO}{{\ensuremath{\mathcal{SF}_{dirs}}}}
\renewcommand{\FD}{{\SF}}
