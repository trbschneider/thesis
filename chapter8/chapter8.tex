...
\newcommand{\SFasym}{{\ensuremath{\mathcal{aSF}}}}
...
\begin{table}[th]
    ...
    \begin{adjustbox}{width={\textwidth},totalheight=\textheight,keepaspectratio}
        	\begin{tabular}{@{}y{0.35\textwidth}x{0.15\textwidth}x{0.15\textwidth}x{0.15\textwidth}@{}}
                \toprule
					& {\SFasym} & {\OI} & {\FD} \\%
				\cmidrule(rl){2-4}
				Free parameters & $w_m$,$\delta_m,\Delta_m,G_m$ & $\delta_m,\Delta_m,G_m$ & $\phi_{m,n},\theta_{m,n}$,$\delta_m,\Delta_m,G_m$ \\
...
%\input{chapter8/figs/exp2_dens_all.tikz}
